...
class ConsultaPacienteAdapter(private val dados: List<ConsultarPacientesCadastradosDTO>, private val contexto: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ConsultaPacienteHolder {
        return ConsultaPacienteHolder(LayoutInflater.from(contexto).inflate(R.layout.item_lista_pacientes_cadastrados, parent, false))
    }
